...
?>
 ...
 <style type="text/css">
        ...
        .wrapper{ width: 350px; padding: 50px; margin-top:50px;}
		body {
...
<center>
	...
	<br>
        <h2><font font-family: Arial, sans-serif; color="#C11C1C">Login</font></h2>
         <p style="font-size:20px;color:#C11C1C;font-family: Arial, sans-serif;">Please fill in your credentials to login.</font></p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group  <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="username"  onfocus="this.value=''" class="hello" value="<?php echo $username; ?>" >
                <span class="help-block"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <label><font font-family: Arial, sans-serif; color="#C11C1C">Password</font></label>
                <input type="password"  name="password"  onfocus="this.value=''"  class="hello" >
